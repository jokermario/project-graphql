...
const get_user_args_dto_1 = require("./dto/args/get-user-args.dto");
...
let UserResolver = exports.UserResolver = class UserResolver {
    ...
    async findOne(getUserArgs) {
        return this.userService.getUser(getUserArgs._email);
    }
};
__decorate([
    (0, graphql_1.Query)(() => String, { name: 'token' }),
    __param(0, (0, graphql_1.Args)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [get_user_args_dto_1.GetUserArgs]),
    __metadata("design:returntype", Promise)
], UserResolver.prototype, "login", null);
__decorate([
    (0, graphql_1.Query)(() => user_entity_1.User, { name: 'findUserByEmail' }),
    __param(0, (0, graphql_1.Args)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [get_user_args_dto_1.GetUserArgs]),
    __metadata("design:returntype", Promise)
